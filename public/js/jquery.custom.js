(function($){
    ...
    $(document).ready(function(){
		...
		/* portfolio section */
		function animate_galeria() {
				
			$('.galeria-section .galeria-box').css('opacity' , 0).each(function( k ) {
		...
		function animate_sections() {
			...
			$('#portfolio-section').waypoint( function( direction ) {
				...
				$('#galeria-section').waypoint( function( direction ) {
								
				if( direction === 'down' && !$(this).hasClass('animated') ) {
					
					setTimeout ( function () {
							$('#galeria-section header').find('.section-title').animate({ opacity: 1 }).addClass('animated');
					}, 200 );
					
					setTimeout ( function () {
							$('#galeria-section header').find('.section-slogan').animate({ opacity: 1 }).addClass('animated');
					}, 600 );
					
					setTimeout( animate_galeria , 1000);
